                        ...
                        @endphp
                            ...
                            <td>
                              <div class="form-floating">
                                <input id="txtQty" type="number" class="form-control" placeholder="Text Input" value="{{$c['quantity']}}" min="0" name="qty{{$c['id']}}">
                            ...
                            <td class="pe-0">
                                <a href="{{url('deletecart',$c['id'])}}" class="link-dark"><i class="uil uil-trash-alt" id="btn-delete" id-item="{{$c['id']}}"></i></a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
